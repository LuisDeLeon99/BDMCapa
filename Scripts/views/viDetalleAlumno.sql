...
SELECT
    ...
    ins.Nombre AS Instructor, -- Agregamos el nombre del instructor
...
LEFT JOIN Usuarios ins ON cu.ID_instructor = ins.ID_usuario -- Unimos la tabla Usuarios para obtener el nombre del instructor
